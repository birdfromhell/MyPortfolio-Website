...
content:
  en: |
    <p>
      As a freelance developer, I work independently and remotely with clients, managing the entire development process from initial communication and requirements gathering to proposal creation, application development, testing, and post-project support.
    </p>
    <p>
      I maintain open communication with clients through email, chat, or video meetings, breaking work into manageable phases, providing regular updates, and using tools like Trello or Notion for task tracking. Documentation and transparency are key parts of my workflow to ensure the final product meets expectations.
    </p>
    <p><strong>My key workflow:</strong></p>
    <ul>
      <li>Requirements analysis and initial client discussions</li>
